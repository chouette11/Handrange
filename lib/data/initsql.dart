...
class InitGraph {
  ...
  static Future<List<InitGraph>> getInitGraph() async {
    ...
    if(maps.length == 0){
      ...
      insertInitGraph(InitGraph(
          id: 3,
          text:"TTTTTTTTTTTTTTTTTTFFFFFFFFTTTTTFFFFFFFFTTFTTFFFFFFFFFFFFTTFFFFFFFFFFFFTFFFFFFFFFFFFFTFFFFFFFFFFFFFTFFFFFFFFFFFFFTFFFFFFFFFFFFFTFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF",
          name: "UTG",
          count: 196),
      );
      insertInitGraph(InitGraph(
      ...
      insertInitGraph(InitGraph(
          id: 6,
          text:"TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTFFFFTTTTTTTTFFFFFTTTTTTTTFFFFFTTTTTTTTFFFFFTFFFFFTTTFFFFTFFFFFFTTTFFFFFFFFFFFTTTFFTFFFFFFFFTTFFFFFFFFFFFFTFFFFFFFFFFFFFTFFFFFFFFFFFFFT",
          name: "BTN",
          count: 474),
      );
    }
